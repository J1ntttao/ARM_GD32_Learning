...
static void timer_init_config(uint32_t timer_periph, uint16_t prescaler, uint32_t period){
    // 重置Timer
...
static void timer_channel_config(uint32_t timer_periph, uint32_t channel, uint8_t enable){
        // 初始化输出通道-------------------------------------------------
