...
#define I2C_WRITE(addr, reg, ptr, num) MX_I2C1_Write(addr, reg, ptr, num)
#define I2C_READ(addr, reg, ptr, num)  MX_I2C1_Read(addr, reg, ptr, num)
...
// 清理Timer定时器标记
void PCF8563_clear_timer(void);

void PCF8563_ext_int_call(void);
