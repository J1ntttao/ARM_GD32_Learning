...
void OLED_Init(void)
{
    GPIO_config(RCU_GPIOA, GPIOA, GPIO_PIN_2);
    GPIO_config(RCU_GPIOA, GPIOA, GPIO_PIN_3);
    GPIO_config(RCU_GPIOA, GPIOA, GPIO_PIN_5);
    GPIO_config(RCU_GPIOA, GPIOA, GPIO_PIN_7);
    GPIO_config(RCU_GPIOC, GPIOC, GPIO_PIN_5);
    
    GPIO_init(RCU_GPIOA, GPIOA, GPIO_PIN_6);
