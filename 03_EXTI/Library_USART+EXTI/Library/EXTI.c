...
#if USE_EXTI3
    #if EXTI3_SOFT
    EXTI_soft_config(EXTI_3, EXTI3_IRQn, EXTI3_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI4
    #if EXTI4_SOFT
    EXTI_soft_config(EXTI_4, EXTI4_IRQn, EXTI4_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI5
    #if EXTI5_SOFT
    EXTI_soft_config(EXTI_5, EXTI5_9_IRQn, EXTI5_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI6
    #if EXTI6_SOFT
    EXTI_soft_config(EXTI_6, EXTI5_9_IRQn, EXTI6_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI7
    #if EXTI7_SOFT
    EXTI_soft_config(EXTI_7, EXTI5_9_IRQn, EXTI7_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI8
    #if EXTI8_SOFT
    EXTI_soft_config(EXTI_8, EXTI5_9_IRQn, EXTI8_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI9
    #if EXTI9_SOFT
    EXTI_soft_config(EXTI_9, EXTI5_9_IRQn, EXTI9_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI10
    #if EXTI10_SOFT
    EXTI_soft_config(EXTI_10, EXTI10_15_IRQn, EXTI10_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI11
    #if EXTI11_SOFT
    EXTI_soft_config(EXTI_11, EXTI10_15_IRQn, EXTI11_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI12
    #if EXTI12_SOFT
    EXTI_soft_config(EXTI_12, EXTI10_15_IRQn, EXTI12_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI13
    #if EXTI13_SOFT
    EXTI_soft_config(EXTI_13, EXTI10_15_IRQn, EXTI13_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI14
    #if EXTI14_SOFT
    EXTI_soft_config(EXTI_14, EXTI10_15_IRQn, EXTI14_IRQ_PRI);
    #else
    EXTI_config(
...
#if USE_EXTI15
    #if EXTI15_SOFT
    EXTI_soft_config(EXTI_15, EXTI10_15_IRQn, EXTI15_IRQ_PRI);
    #else
    EXTI_config(
