...
#define SPI0_PRESCALE		    SPI_PSC_2
//极性和相位：
//	SPI_CK_PL_LOW_PH_1EDGE 	    0，0
//	SPI_CK_PL_HIGH_PH_1EDGE     1，0
//	SPI_CK_PL_LOW_PH_2EDGE   	0，1
//	SPI_CK_PL_HIGH_PH_2EDGE	    1，1
#define SPI0_CLOCK_CPOL_CPHA	SPI_CK_PL_LOW_PH_1EDGE
// 大小端：
//	SPI_ENDIAN_MSB： 大端
//	SPI_ENDIAN_LSB： 小端
#define SPI0_CLOCK_ENDIAN		SPI_ENDIAN_MSB
...
#define SPI1_SCL_RCU	  RCU_GPIOB
#define SPI1_SCL_PORT		    GPIOB
#define SPI1_SCL_PIN		    GPIO_PIN_10

#if SPI1_MOSI_ENABLE
// PB15(AF5),PC1(AF5),PC3(AF5),PI3(AF5)
#define SPI1_MOSI_RCU	RCU_GPIOB
...
#define SPI1_MISO_RCU	RCU_GPIOB
#define SPI1_MISO_PORT		GPIOB
#define SPI1_MISO_PIN		GPIO_PIN_14
#endif

//预分频：SPI_PSC_x x为(2, 4, 8, 16, 32, 64, 128, 256)
#define SPI1_PRESCALE		SPI_PSC_4
//极性和相位：
//	SPI_CK_PL_LOW_PH_1EDGE：	0，0
//	SPI_CK_PL_HIGH_PH_1EDGE：	1，0
//	SPI_CK_PL_LOW_PH_2EDGE：  0，1
//	SPI_CK_PL_HIGH_PH_2EDGE：	1，1
#define SPI1_CLOCK_CPOL_CPHA	SPI_CK_PL_HIGH_PH_2EDGE
// 大小端：
//	SPI_ENDIAN_MSB： 大端
//	SPI_ENDIAN_LSB： 小端
#define SPI1_CLOCK_ENDIAN		SPI_ENDIAN_MSB
...
#define SPI2_MOSI_RCU	RCU_GPIOC
...
#if SPI2_MISO_ENABLE
// PB4(AF6),PC11(AF6)
#define SPI2_MISO_RCU	RCU_GPIOB
#define SPI2_MISO_PORT		GPIOB
#define SPI2_MISO_PIN		GPIO_PIN_4
#endif

//预分频：SPI_PSC_x x为(2, 4, 8, 16, 32, 64, 128, 256)
#define SPI2_PRESCALE		SPI_PSC_2
//极性和相位：
//	SPI_CK_PL_LOW_PH_1EDGE：	0，0
//	SPI_CK_PL_HIGH_PH_1EDGE：	1，0
//	SPI_CK_PL_LOW_PH_2EDGE：	0，1
//	SPI_CK_PL_HIGH_PH_2EDGE：	1，1
#define SPI2_CLOCK_CPOL_CPHA	SPI_CK_PL_LOW_PH_1EDGE
// 大小端：
//	SPI_ENDIAN_MSB： 大端
//	SPI_ENDIAN_LSB： 小端
#define SPI2_CLOCK_ENDIAN		SPI_ENDIAN_MSB
...
#define SPI3_SCL_RCU	RCU_GPIOC
#define SPI3_SCL_PORT		GPIOC
#define SPI3_SCL_PIN		GPIO_PIN_10

#if SPI3_MOSI_ENABLE
// PA1(AF5),PE6(AF5),PE14(AF5),PG13(AF6)
#define SPI3_MOSI_RCU	RCU_GPIOC
...
#define SPI3_MISO_RCU	RCU_GPIOB
#define SPI3_MISO_PORT		GPIOB
#define SPI3_MISO_PIN		GPIO_PIN_4
#endif

//预分频：SPI_PSC_x x为(2, 4, 8, 16, 32, 64, 128, 256)
#define SPI3_PRESCALE		SPI_PSC_2
//极性和相位：
//	SPI_CK_PL_LOW_PH_1EDGE：	0，0
//	SPI_CK_PL_HIGH_PH_1EDGE：	1，0
//	SPI_CK_PL_LOW_PH_2EDGE：  	0，1
//	SPI_CK_PL_HIGH_PH_2EDGE：	1，1
#define SPI3_CLOCK_CPOL_CPHA	SPI_CK_PL_LOW_PH_1EDGE
// 大小端：
//	SPI_ENDIAN_MSB： 大端
//	SPI_ENDIAN_LSB： 小端
#define SPI3_CLOCK_ENDIAN		SPI_ENDIAN_MSB
...
#define SPI4_SCL_RCU	RCU_GPIOC
#define SPI4_SCL_PORT		GPIOC
#define SPI4_SCL_PIN		GPIO_PIN_10

#if SPI4_MOSI_ENABLE
// PA10(AF6),PB8(AF6),PBE14(AF6),PF9(AF5),PF11(AF5)
#define SPI4_MOSI_RCU	RCU_GPIOC
...
#define SPI4_MISO_RCU	RCU_GPIOB
#define SPI4_MISO_PORT		GPIOB
#define SPI4_MISO_PIN		GPIO_PIN_4
#endif

//预分频：SPI_PSC_x x为(2, 4, 8, 16, 32, 64, 128, 256)
#define SPI4_PRESCALE		SPI_PSC_2
//极性和相位：
//	SPI_CK_PL_LOW_PH_1EDGE：	0，0
//	SPI_CK_PL_HIGH_PH_1EDGE：	1，0
//	SPI_CK_PL_LOW_PH_2EDGE：  0，1
//	SPI_CK_PL_HIGH_PH_2EDGE：	1，1
#define SPI4_CLOCK_CPOL_CPHA	SPI_CK_PL_LOW_PH_1EDGE
// 大小端：
//	SPI_ENDIAN_MSB： 大端
//	SPI_ENDIAN_LSB： 小端
#define SPI4_CLOCK_ENDIAN	SPI_ENDIAN_MSB
...
// PG13(AF5)
#define SPI5_SCL_RCU		RCU_GPIOC
#define SPI5_SCL_PORT			GPIOC
#define SPI5_SCL_PIN			GPIO_PIN_10
#define SPI5_SCL_AF				GPIO_AF_6
#if SPI5_MOSI_ENABLE
// PG14(AF5)
#define SPI5_MOSI_RCU		RCU_GPIOC
...
#if SPI5_MISO_ENABLE
// PG12(AF5)
#define SPI5_MISO_RCU		RCU_GPIOB
#define SPI5_MISO_PORT			GPIOB
#define SPI5_MISO_PIN			GPIO_PIN_4
#define SPI5_MISO_AF			GPIO_AF_6
#endif
//预分频：SPI_PSC_x x为(2, 4, 8, 16, 32, 64, 128, 256)
#define SPI5_PRESCALE			SPI_PSC_2
//极性和相位：
//	SPI_CK_PL_LOW_PH_1EDGE：	0，0
//	SPI_CK_PL_HIGH_PH_1EDGE：	1，0
//	SPI_CK_PL_LOW_PH_2EDGE：  	0，1
//	SPI_CK_PL_HIGH_PH_2EDGE：	1，1
#define SPI5_CLOCK_CPOL_CPHA	SPI_CK_PL_LOW_PH_1EDGE
// 大小端：
//	SPI_ENDIAN_MSB： 大端
//	SPI_ENDIAN_LSB： 小端
#define SPI5_CLOCK_ENDIAN		SPI_ENDIAN_MSB
