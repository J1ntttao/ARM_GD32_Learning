...
// ================================= TIMER2 ================================= 
    ...
    #ifdef TM2_CH0
    timer_gpio_config(TM2_CH0,  GPIO_AF_2);
    // 初始化Timer2 CH0通道
    TIMER_channel_config(TIMER2, TIMER_CH_0, ENABLE);
    #endif
    
    #ifdef TM2_CH1
    timer_gpio_config(TM2_CH1,  GPIO_AF_2);
    // 初始化Timer2 CH1通道
    TIMER_channel_config(TIMER2, TIMER_CH_1, ENABLE);
    #endif
