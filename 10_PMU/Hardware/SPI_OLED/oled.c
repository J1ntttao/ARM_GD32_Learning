...
void OLED_Init(void)
{
//    GPIO_config(RCU_GPIOA, GPIOA, GPIO_PIN_5); // SCL
//    GPIO_config(RCU_GPIOA, GPIOA, GPIO_PIN_7); // MOSI
//    GPIO_init(RCU_GPIOA, GPIOA, GPIO_PIN_6);   // MISO
    
    GPIO_config(RCU_GPIOA, GPIOA, GPIO_PIN_2);  // DC
    GPIO_config(RCU_GPIOA, GPIOA, GPIO_PIN_3);  // CS1
    GPIO_config(RCU_GPIOC, GPIOC, GPIO_PIN_5);  // CS2
